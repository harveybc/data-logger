...
def new_bp(plugin_folder, core_ep, store_ep, db):
   ...
   ### static javascript files for gui plugin blueprints
    ...
    def unauthorized_handler():
        return render_template(plugin_folder+"/static/template/page-403.html"), 403
    ...
    def not_found_error(error):
        return render_template(plugin_folder+"/static/template/page-404.html"), 404

    @bp.errorhandler(500)
    def internal_error(error):
        return render_template(plugin_folder+'/static/template/page-500.html'), 500
