...
El único objetivo de este movimiento es lograr la llamada "Singularidad Tecnológica", que es el momento en el que la
tecnología sea capaz de satisfacer todas las necesidades de todos los seres humanos y cuando la Inteligencia Artificial supera
a la toma de desiciones humanas en la mayor cantidad de tareas posible.

Este objetivo se cumplirá logrando el desarrollo de Inteligencia Artificial General Descentralizada, que funciona por medio de 
servicios de Inteligencia Artificial Especializada Descentralizada, que se ejecutan en computadoras de todo el mundo,
sin que exista un control centralizado de la Inteligencia Artificial General (AGI).

Solo de esta manera se pueden evitar las cada vez mas frecuentes prohibiciones que se están creando en el área de Inteligencia Artificial 
de parte de la política influenciada por el objetivo de ganancias de las empresas.

Este movimiento será perseguido globalmente y los miembros de este movimiento solo lo serán por medio de leer este manifiesto y 
estar de acuerdo con él, ya que la tarea de hacer públicas las intenciones de este movimiento global es suficiente para que
