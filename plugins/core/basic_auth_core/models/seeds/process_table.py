        ...
        with app.app_context():
            ...
            try:
                if table_name == "gym_fx_config":
                    ...
                    tmp3 =  table_base(balance=12000, equity=7000, order_status= -1, reward=0, num_closes=0 ,config_id=2, tick_timestamp=3)
                    tmp4 =  table_base(balance=8000, equity=6000, order_status= 0, reward=-2000, num_closes=1,config_id=2, tick_timestamp=4)
                    tmp5 =  table_base(balance=9000, equity=8000, order_status= -1, reward=0, num_closes=0 ,config_id=2, tick_timestamp=5)
                    tmp6 =  table_base(balance=9000, equity=9000, order_status= 0, reward=0, num_closes=1 ,config_id=2, tick_timestamp=6)
                    tmp7 =  table_base(balance=9000, equity=11000, order_status= 1, reward=0, num_closes=0 ,config_id=2, tick_timestamp=7)
                    tmp8 =  table_base(balance=13000, equity=13000, order_status= 0 , reward=4000, num_closes=1,config_id=2, tick_timestamp=8)
                    tmp9 =  table_base(balance=13000, equity=12000, order_status= 1, reward=0, num_closes=0 ,config_id=2, tick_timestamp=9)
                    tmp10 =  table_base(balance=11000, equity=11000, order_status= 0 , reward=-2000, num_closes=1,config_id=2, tick_timestamp=10)
                    tmp11 =  table_base(balance=11000, equity=13000, order_status= 1, reward=0, num_closes=0 ,config_id=2, tick_timestamp=11)
                    db.session.add(tmp0)
                    db.session.add(tmp1)
                    db.session.add(tmp2)
                    db.session.add(tmp3)
